 ...
 */
public class PurchaseTenderDetailDocOut implements Serializable,Comparable{
    ...
    public int compareTo(Object o) {
        PurchaseTenderDetailDocOut purchaseTenderDetailDoc = (PurchaseTenderDetailDocOut) o;
