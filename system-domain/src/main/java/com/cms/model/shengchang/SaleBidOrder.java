 ...
 */
public class SaleBidOrder implements Serializable{
    ...
    private List<SaleBidOrderDetail> saleBidOrderDetailList=new ArrayList<SaleBidOrderDetail>();
    ...
    private List<SaleBidOrderDetail> delSalebidOrderDetailList=new ArrayList<SaleBidOrderDetail>();
    ...
    public List<SaleBidOrderDetail> getDelSalebidOrderDetailList() {
        return delSalebidOrderDetailList;
    }
    public void setDelSalebidOrderDetailList(List<SaleBidOrderDetail> delSalebidOrderDetailList) {
        this.delSalebidOrderDetailList = delSalebidOrderDetailList;
    }
    ...
    public List<SaleBidOrderDetail> getSaleBidOrderDetailList() {
        return saleBidOrderDetailList;
    }
    public void setSaleBidOrderDetailList(List<SaleBidOrderDetail> saleBidOrderDetailList) {
