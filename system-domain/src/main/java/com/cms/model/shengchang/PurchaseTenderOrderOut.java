 ...
 */
public class PurchaseTenderOrderOut implements Serializable{
    ...
    private List<PurchaseTenderDetailOut> purchaseTenderDetailList=new ArrayList<PurchaseTenderDetailOut>();
    private String purchaseTenderSourceId="";
    private String purchaseTenderSourceName="";
    private List<PurchaseTenderAreaOut> purchaseTenderAreaList=new ArrayList<PurchaseTenderAreaOut>();
    private Integer state;
    private String stateName;
    private String updateTime;
    private Boolean cyxz;
    private List<PurchaseTenderOrderSupplierOut> purchaseTenderOrderSupplierList=new ArrayList<PurchaseTenderOrderSupplierOut>();
    ...
    public List<PurchaseTenderDetailOut> getPurchaseTenderDetailList() {
        return purchaseTenderDetailList;
    }
    public void setPurchaseTenderDetailList(List<PurchaseTenderDetailOut> purchaseTenderDetailList) {
        this.purchaseTenderDetailList = purchaseTenderDetailList;
    }
    public List<PurchaseTenderAreaOut> getPurchaseTenderAreaList() {
        return purchaseTenderAreaList;
    }
    public void setPurchaseTenderAreaList(List<PurchaseTenderAreaOut> purchaseTenderAreaList) {
        this.purchaseTenderAreaList = purchaseTenderAreaList;
    }
    public List<PurchaseTenderOrderSupplierOut> getPurchaseTenderOrderSupplierList() {
        return purchaseTenderOrderSupplierList;
    }
    public void setPurchaseTenderOrderSupplierList(List<PurchaseTenderOrderSupplierOut> purchaseTenderOrderSupplierList) {
