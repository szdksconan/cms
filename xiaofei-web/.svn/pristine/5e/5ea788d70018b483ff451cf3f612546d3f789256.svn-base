...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/dianx.js"></script>
</head>
<body>
<!-- 收藏弹出通用模态化窗口-->
...
<!-- 展示图-->
<div class="xf_thd"><img src="${pageContext.request.contextPath}/images/dianxitu.jpg"> </div>
<!--   主要浮动菜单广告图-->
<div class="xf_cxd" style="height: 114px;">

 <div>
   <span>
    <img src="${pageContext.request.contextPath}/images/nm1.jpg">
    <div>
      <P>
     ...
     <span>
    <img src="${pageContext.request.contextPath}/images/nm2.jpg">
    <div>
        <P>
            <a href="javascript:void(0);">五金行业</a>
            <a href="javascript:void(0);">汽车用品</a>
     ...
     <span>
    <img src="${pageContext.request.contextPath}/images/nm3.jpg">
    <div>
        <P>
            <a href="javascript:void(0);">五金行业</a>
            <a href="javascript:void(0);">汽车用品</a>
...
<!--图片-->
<!--图片-->
<div class="xf_tuimg_div">
	<div id="goodsList" class="xf_tu">
