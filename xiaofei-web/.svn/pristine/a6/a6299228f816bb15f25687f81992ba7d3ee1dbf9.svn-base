...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/cmaoxiaofei.css">
    ...
    <script src="${pageContext.request.contextPath}/js/xiaofei_ajax/dingzhi.js"></script>
...
<div class="xf_thd" >
    ...
    <div class="xf_tongjiy ge_ren"  >
        <div class="xf_getou" >
            <img src="${pageContext.request.contextPath}/images/gang.jpg">&nbsp;所有定制记录
            <span> <a   class="btn btn-hu btn-w80" type="button" onclick="ding_zhi_OK(1,2);" style="width: 55px;height: 32px;padding-top: 4px;margin: 0 0 20px 5px ;float: right;" >搜索</a></span>
            <div class="xf_sou1 fl" style="border: 1px solid #dddddd;width: 150px;margin:0 0 0 0;height: 32px;padding-top: 4px;float: right;">

                <input type="text" class="xf_input" placeholder="标题" style="width: 120px;border: 0;" />
        ...
        <span class="xf_zx_user" id="xf_zx_user"></span>
