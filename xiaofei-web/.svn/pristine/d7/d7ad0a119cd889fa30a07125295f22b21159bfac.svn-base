...
<div class="xf_thd">
       <table style="margin: 30px 0 0 20px;">
        ...
        <tr>
            <td>
               <span style="font-size: 22px;"> 您的我要运货的订单需求，已经通过平台发出，<br/>您可以在个人中心查看您的订单记录详情</span>
                <a style="margin-left: 30px" href="index_people.jsp" target="_self" class="btn btn-he btn-w150" type="button">去查看记录</a>
                <a style="margin-left: 30px" href="../index_wli.jsp" target="_self" class="btn btn-he btn-w150" type="button">去看其它的需求</a>
        </tr>
        </tbody>
    </table>
</div>
