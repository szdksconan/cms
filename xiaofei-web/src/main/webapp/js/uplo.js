...
(function ($) {  
    var defaultSettings = {  
        ...
        maximumFilesUpload: 4,//最大文件选择数(当此属性大于1时，buttonFeature属性只能为true)
...
UploadAssist.prototype = {  
    ...
    createInputFile: function () {  
        ...
        var form = $('<form method="post" target="iframe' + randomNum + '" enctype="multipart/form-data" action="' + that.settings.url+"&num="+that.num++ + '" name="' + formName + '"></form>');  
        form.append(input);  
