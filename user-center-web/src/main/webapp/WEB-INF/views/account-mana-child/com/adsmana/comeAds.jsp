...
<script src="${ctx}/js/accountCom/comAdd.js"></script>
		  	...
		  	<table class="acc-saveadstb">
		  		...
		  		<c:forEach items="${adsLists}" var="ads">
		  			<tr>
		  				...
		  				<td><input type="button" id="delBtn" onclick="deleteAds('/user-center-web/accountCom/deleteAds?id=${ads.id}')" value="删除" class="acc-adsdel"></td>
		  			</tr>
		  		</c:forEach>
		  		</tbody>
		  	</table>
