...
<head>
<c:if test="${fn:contains(sessionInfo.accessList, '/area/delete')}">
	<script type="text/javascript">
		$.canDel = true;
	</script>
</c:if>
<c:if test="${fn:contains(sessionInfo.accessList, '/area/edit')}">
	<script type="text/javascript">
		$.canEdit = true;
	</script>
</c:if>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'center',border:false" >
   	...
   	<div id="toolbar" style="display: none;">
			<c:if test="${fn:contains(sessionInfo.accessList, '/area/add')}">
