...
<div style="padding: 3px;">
	<form id="departmentEditForm" method="post">
		<table class="grid">
			<tr>
				<td>部门名称</td>
				<td><input type="hidden" name="id" value="${department.id }"/><input name="name" type="text" value="${department.name}" placeholder="请输入部门名称"  class="easyui-validatebox" data-options="required:true,validType:['notSpace','length[1,40]']" ></td>
			</tr>
			<tr>
				<td>所属网点</td>
