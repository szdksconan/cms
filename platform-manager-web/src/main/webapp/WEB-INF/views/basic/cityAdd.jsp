		...
		<form id="cityAddForm" method="post">
			<table class="grid">
					...
					<tr>
						...
						<td>所属地市</td>
						<td><input id="aid"    name="aid" type="text"  class="easyui-combobox"   style="background:transparent;border:0"></td>
					</tr>
					<tr>
						<td>线路区划</td>
						<td><input id="lid"    name="lid" type="text" class="easyui-combobox"   style="background:transparent;border:0"></td>
					</tr>
			</table>
		</form>
	</div>
