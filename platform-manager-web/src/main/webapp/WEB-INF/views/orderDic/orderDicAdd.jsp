...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#pid').combotree({
			url : '${ctx}/orderDic/allTree?flag=true',
			parentField : 'pid',
			lines : true,
			panelHeight : 'auto'
		});
...
<div style="padding: 3px;">
	<form id="orderDicAddForm" method="post">
		<table class="grid">
			<tr>
				<td>编号</td>
				<td><input name="dicno" class="easyui-validatebox" data-options="required:true,validType:['length[1,10]','nonChinese']" style="background:transparent;border:0" ></td>
				</tr>
				<tr>
				<td>名称</td>
